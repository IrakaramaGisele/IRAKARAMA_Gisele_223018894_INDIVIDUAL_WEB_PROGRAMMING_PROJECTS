...
<body>
        ...
        <div class="container">
            <div class="hero-panel">
                <div class="hero-copy">
                    ...
                    <h1>Welcome to One&Only Hotel</h1>
    ...
    <div class="container">
        ...
        <div class="section about-card" id="about">
            <h2>About Us</h2>
            <p>At One&Only Hotel, we offer premium comfort, fine dining and world-class hospitality. Our hotel is designed to deliver a luxurious and relaxing experience for every guest. Whether you are visiting for business or leisure, we provide elegant rooms, exceptional service, and unforgettable moments in a peaceful environment.</p>
        ...
        <div class="section menu-card" id="menu">
            ...
            <table>
                ...
                <tr><td>Drink</td><td>FRW3000 </td></tr>
                <tr><td>Fresh Juice</td><td>FRW 3000</td></tr>
                <tr><td>Coffee</td><td>FRW 4000</td></tr>
                <tr><td>Chicken Burger</td><td>FRW 6000</td></tr>
                <tr><td>Pasta</td><td>FRW 3500</td></tr>
